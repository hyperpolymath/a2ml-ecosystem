...
A pure Gleam library for parsing, manipulating, and rendering A2ML (AI
Attestation Markup Language) documents. Provides full A2ML parser with
error reporting, manifest extraction, and roundtrip fidelity for
...
* Trust-level validation: structural only (enum values), cryptographic
