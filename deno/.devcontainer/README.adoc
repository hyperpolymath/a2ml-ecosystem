...
Replace `A2ML Ecosystem Coordination Hub` placeholders in both `devcontainer.json` and `Containerfile` with your actual project name. Run `just deps` to verify the environment after first launch.
