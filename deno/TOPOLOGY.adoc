...
Deno-native parser and renderer for A2ML (Attested Markup Language),
written in AffineScript and compiled to JavaScript ES modules. Provides
parse-render round-trip support for A2ML documents with trust-level
hierarchy and directive blocks. Consumed by Deno runtimes and published
to JSR.
