...
sed -i 's/a2ml-validate-action/my-project/g' $(grep -rl 'a2ml-validate-action' .)
...
| `` | Previous/secondary email (for .mailmap) | `old@example.com` | .mailmap |
...
| `https://github.com/hyperpolymath/a2ml-validate-action` | Project website | `https://example.org` | SECURITY.md |
...
| `` | One-line project description | `FFI bridges between languages` | STATE.a2ml |
