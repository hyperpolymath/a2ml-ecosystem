...
= A2ML Estate Normaliser
:toc: left
:icons: font

Estate-wide A2ML (Attestation Markup Language) file normaliser - ensures correct structure across all repositories.
...
[source,bash]
----
cd a2ml/a2ml-estate-normaliser
cargo build --release
----
...
[source,bash]
----
./target/release/a2ml-estate-normaliser --estate-root /path/to/repos
----
...
[source,bash]
----
./target/release/a2ml-estate-normaliser --estate-root /path/to/repos --execute
----
...
[source,bash]
----
./target/release/a2ml-estate-normaliser --estate-root /path/to/repos --mode transpile --execute
----
...
[source,bash]
----
./target/release/a2ml-estate-normaliser --estate-root /path/to/repos --mode organize --execute
----
...
[source,bash]
----
./target/release/a2ml-estate-normaliser --estate-root /path/to/repos --mode documents --execute
----
...
[source,bash]
----
./target/release/a2ml-estate-normaliser --repos repo1,repo2,repo3 --execute
----
