...
VS Code extension providing syntax highlighting, language configuration,
and snippets for A2ML (AI-to-Machine Language) files. Enables editor
support for `+.a2ml+` manifests used across RSR repos. Published to the
VS Code marketplace (MPL-2.0 required by platform).
