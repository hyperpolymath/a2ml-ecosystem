...
= a2ml-haskell Container Templates
:toc: left
:toclevels: 3
:sectnums:
...
All files use `REMOVED` tokens that are replaced by `just container-init`
...
(service name, port, registry) and substitutes all `REMOVED`
