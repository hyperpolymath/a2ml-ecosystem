...
All placeholders in this template follow the `REMOVED` pattern.
...
sed -i 's/a2ml-haskell/my-project/g' $(grep -rl 'a2ml-haskell' .)
sed -i 's/a2ml-haskell/MY_PROJECT/g' $(grep -rl 'a2ml-haskell' .)
...
sed -i "s/2026-07-08/$(date +%Y-%m-%d)/g" $(grep -rl '2026-07-08' .)
```
...
| `hyperpolymath` | Author's organization/affiliation | `Acme University` | project-metadata.k9.ncl |
...
| `2026-07-08` | Current date (ISO) | `2026-02-14` | STATE.a2ml, MAINTAINERS.md |
| `2026-07-08` | Last updated date | `2026-02-14` | TOPOLOGY.md, THREAT-MODEL.md |

### Contact & Security

| Placeholder | Description | Example | Files |
|---|---|---|---|
| `security@example.com` | Security contact email | `security@example.org` | SECURITY.md |
| `0000000000000000000000000000000000000000` | 40-char PGP fingerprint | `ABCD 1234 ...` | SECURITY.md |
| `https://keys.openpgp.org/vks/v1/by-fingerprint/0000000000000000000000000000000000000000` | URL to public PGP key | `https://keys.openpgp.org/...` | SECURITY.md |
| `https://github.com/hyperpolymath` | Project website | `https://example.org` | SECURITY.md |
| `conduct@example.com` | Conduct reports email | `conduct@example.org` | CODE_OF_CONDUCT.md |
...
| `A hyperpolymath project` | One-line project description | `FFI bridges between languages` | STATE.a2ml |
...
These are **not** standard `REMOVED` markers -- they are TODO markers
